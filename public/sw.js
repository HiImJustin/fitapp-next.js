    ...
    !(function () {
            ...
            get(e, t, s) {
                if (e instanceof IDBTransaction) {
                    ...
                    if ("objectStoreNames" === t)
                        return e.objectStoreNames || v.get(e);
                    if ("store" === t)
        ...
        class O {
            ...
            async cacheMatch(e) {
                ...
                for (const c of this.iterateCallbacks(
                    ...
                    p = u
                        ? await (async function (e, t, s, n) {
                              ...
                              const r = Object.assign(Object.assign({}, n), {
                                  ...
                                  i = await e.keys(t, r);
                              for (const c of i)
                                  if (a === o(c.url, s)) return e.match(c, n);
        ...
        class j extends K {
            ...
            async _handle(e, s) {
                ...
                const c = await s.waitUntil(
                    (async () =>
                        (await s.waitUntil(Promise.race(a))) || (await i))()
                );
            ...
            activate(e) {
                return p(e, async () => {
                    const e = await self.caches.open(this.strategy.cacheName),
                        ...
                        n = [];
                    for (const a of t)
                        s.has(a.url) || (await e.delete(a), n.push(a.url));
        ...
        var re,
            ...
            ce = [
                {
                    revision: "c1d73504aa76f29d1236d9b4bf08de21",
                    url: "/_next/static/Fbtk-Y9SvoKNnhkVVHh0E/_buildManifest.js",
                },
                {
                    revision: "fb2823d66b3e778e04a3f681d0d2fb19",
                    url: "/_next/static/Fbtk-Y9SvoKNnhkVVHh0E/_middlewareManifest.js",
                },
                {
                    revision: "b6652df95db52feb4daf4eca35380933",
                    url: "/_next/static/Fbtk-Y9SvoKNnhkVVHh0E/_ssgManifest.js",
                },
                {
                ...
                {
                    revision: "d8040eaf70ffbb27",
                    url: "/_next/static/chunks/pages/_app-d8040eaf70ffbb27.js",
                },
                {
                ...
                {
                    revision: "d9230c4948d4327a",
                    url: "/_next/static/chunks/pages/fallback-d9230c4948d4327a.js",
                },
                {
                    revision: "ec4df9fb38d055df",
                    url: "/_next/static/chunks/pages/foodLog-ec4df9fb38d055df.js",
                },
                {
                    revision: "3654b09b80cca55f",
                    url: "/_next/static/chunks/pages/index-3654b09b80cca55f.js",
                },
                {
                ...
                {
                    revision: "212083d465ade464",
                    url: "/_next/static/css/212083d465ade464.css",
                },
                {
                ...
                {
                    revision: "8e1332af750fc240",
                    url: "/_next/static/css/8e1332af750fc240.css",
                },
                {
                ...
                {
                    revision: "5de08f7ebe39cccf54479edea591c320",
                    url: "/manifest.json",
                },
                { revision: "e0f86f9be4ba7f9fa93fa7fe7d7c0c7d", url: "/sw.js" },
                {
                    revision: "26bf2d0adaf1028a4d4c6ee77005e819",
                    url: "/vercel.svg",
                },
            ];
        ce.push({ url: "/fallback", revision: "1234567890" }),
            (function (e) {
                se().precache(e);
            })(ce),
            (function (e) {
